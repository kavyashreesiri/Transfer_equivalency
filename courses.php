                ...
                <div class="pl-2 pb-1 state_alert" style="color:red; font-family: Calibri; display: none;">Please do not select more than 1 State</div>
                   ...
                   <?php        
                            if(isset($_POST['state_state'])) {
                                            ...
                                            {
                                                if($row["STVSTAT_DESC"]==$_POST['state_state']) {
                                                                   
                                    ?>         
                                             <div class="form-check mb-1">
                                                <label class="form-check-label" for="check1">
                                                    <input type="checkbox" class="form-check-input" id="" name="option_state" value="<?php echo $row["STVSTAT_DESC"]; ?>" checked><?php echo $row["STVSTAT_DESC"]; ?>
                                                </label>
                                            </div>    
                        ...
                        <?php
                                           ...
                                           ?>
                                            ...
                                            <div class="form-check mb-1">
                                                <label class="form-check-label" for="check1">
                                                    <input type="checkbox" class="form-check-input" id="" name="option_state" value="<?php echo $row["STVSTAT_DESC"]; ?>"><?php echo $row["STVSTAT_DESC"]; ?>
                                                </label>
                                            </div>
                      ...
                      <div class="pl-2 pb-1 school_alert" style="color:red; font-family: Calibri; display: none;">Please do not select more than 1 School</div>
                        <div id="demoAcc1" class="w3-show w3-white mb-1">
                           <div class="w3-container ml-3" style="background-color: white; width:89%;">
                                ...
                                <?php 
                                         ...
                                         if($landing_result_name10['STVSBGI_DESC']==$school_desc)
                                   ...
                                   ?>             
                                            <div class="form-check mb-1">
                                                <label class="form-check-label" for="check1">
                                                    <input type="checkbox" class="form-check-input" id="" name="option1" value="<?php  echo $landing_result_name10['STVSBGI_DESC']; ?>" checked><?php  echo $landing_result_name10['STVSBGI_DESC']; ?>
                                                </label>
                                            </div>
                        ...
                        <?php
                            ...
                            ?>
                                            ...
                                            <div class="form-check mb-1">
                                                <label class="form-check-label" for="check1">
                                                    <input type="checkbox" class="form-check-input" id="" name="option1" value="<?php  echo $landing_result_name10['STVSBGI_DESC']; ?>"><?php  echo  $landing_result_name10['STVSBGI_DESC']; ?>
                                                </label>
                                            </div>
                ...
                <div id="demoAcc" class="w3-show w3-white">
                    ...
                    <?php        
                            if(isset($_POST['school_state'])) {
                                                ...
                                                require_once 'database.php';
                                                $school_subject_filter = ($_POST['school_state']);
                                                
                                                if(isset($_POST['subject_number_name']))
                                                {
                                                $subject_filter=($_POST['subject_number_name']);
                                               // $course_filter=($_POST['course_number_name']);
                                                 
                                                $usersStrs =  implode("','", $subject_filter);
                                                }
                             
                                            
                                            $filter_subject_code_sbgiop = $_POST['sbgi_value'];
                                             
                                            $filter_subject_retrieve3="SELECT DISTINCT SUBJ_CODE_FROM_SCHOOL FROM V_WX_EQUIVALENCY_LIST where SBGI_CODE='".$filter_subject_code_sbgiop."' ORDER BY SUBJ_CODE_FROM_SCHOOL ASC";
                                            ...
                                            {       
                                             ...
                                             <div class="form-check mb-1">
                                                <label class="form-check-label" for="check1">
                                                    <input type="checkbox" class="form-check-input" id="" name="subject_option" value="<?php echo $filter_subject_result_name['SUBJ_CODE_FROM_SCHOOL']; ?>" checked><?php echo $filter_subject_result_name['SUBJ_CODE_FROM_SCHOOL']; ?>
                                                </label>
                                            </div>    
                        ...
                        ?>                               
                                        <div class="form-check mb-1">
                                            <label class="form-check-label" for="check1">
                                                <input type="checkbox" class="form-check-input" id="" name="subject_option" value="<?php echo $filter_subject_result_name['SUBJ_CODE_FROM_SCHOOL']; ?>"><?php echo $filter_subject_result_name['SUBJ_CODE_FROM_SCHOOL']; ?>
                                            </label>
                                        </div>
                ...
                <div id="demoAcc2" class="w3-show w3-white">
                   ...
                   <?php        
                            if(isset($_POST['school_state'])) {
                                                ...
                                                require_once 'database.php';
                                                $school_course_filter = ($_POST['school_state']);
                                               ...
                                               // $subject_filter=($_POST['subject_number_name']);
                                                ...
                                                $usersStrs1 =  implode("','", $course_filter);
                                                }
                             
                                            
                                            $filter_course_code_sbgiop = $_POST['sbgi_value'];
                                             
                                            $filter_course_retrieve3="SELECT DISTINCT CRSE_NUMB_FROM_SCHOOL FROM V_WX_EQUIVALENCY_LIST where SBGI_CODE='".$filter_course_code_sbgiop."' ORDER BY CRSE_NUMB_FROM_SCHOOL ASC";
                                            
                                            $filter_course_statement_id3 = oci_parse($conn,$filter_course_retrieve3);
                                            
                                            oci_execute($filter_course_statement_id3);                                                                            
                                            
                                            
                                                   while($filter_course_result_name = oci_fetch_array($filter_course_statement_id3, OCI_BOTH+OCI_RETURN_NULLS))
                                            ...
                                            {       
                                                   ...
                                                   if (in_array($filter_course_result_name['CRSE_NUMB_FROM_SCHOOL'], $course_filter)) 
                                                   
                                                   {
                                                        
                                                       foreach($course_filter as $strings)
                                               
                                                {
                                                    
                                                    
                                                    if($filter_course_result_name['CRSE_NUMB_FROM_SCHOOL'] == $strings)
                                             ...
                                             <div class="form-check mb-1">
                                                <label class="form-check-label" for="check1">
                                                    <input type="checkbox" class="form-check-input" id="" name="option2" value="<?php echo $filter_course_result_name['CRSE_NUMB_FROM_SCHOOL']; ?>" checked><?php echo $filter_course_result_name['CRSE_NUMB_FROM_SCHOOL']; ?>
                                                </label>
                                            </div>    
                        ...
                        ?>                               
                                            <div class="form-check mb-1">
                                                <label class="form-check-label" for="check1">
                                                    <input type="checkbox" class="form-check-input" id="" name="option2" value="<?php echo $filter_course_result_name['CRSE_NUMB_FROM_SCHOOL']; ?>"><?php echo $filter_course_result_name['CRSE_NUMB_FROM_SCHOOL']; ?>
                                                </label>
                                            </div>
      ...
      <!-- Main page implemented using W3.css and jquery  datatables -->
        ...
        <div class="w3-container">
            ...
            <div class="w3-right-align pt-2">
                  ...
                  <button style="background-color:#00223d; color:white" class="w3-button w3-border w3-small" data-toggle="modal" data-target="#myModal1">My Favorites<span class="badge badge-light ml-1 bagdecount">0</span></button>
                  <button style="background-color:#00223d; color:white" class="w3-button w3-border w3-small" data-toggle="modal" data-target="#myModal2">Email My Favorites</button>
            ...
            <div class="modal" id="myModal1" style="font-weight:bold; font-family: Calibri">
                <div class="modal-dialog modal-dialog-centered modal-lg">
                  <div class="modal-content" >
                    ...
                    <!-- Modal Header -->
                    <div class="modal-header">
                      <h3 class="modal-title" style="font-weight: bold; font-family: Calibri">My Favorites</h3>
                      <button type="button" class="close" data-dismiss="modal">&times;</button>
                    </div>
                    ...
                    <div class="modal-body" >
                         ...
                         <div class="row mb-2" style="float: right; margin-top: -15px;"> <button type="button" style="font-size: 1.1em; font-weight: bold; font-family: Calibri; color:#6c6c6c" class="btn btn-link favclearbtn"><span style="padding-right:4px"><i class="fa fa-close" aria-hidden="true"></i></span>Clear All Favorites</button></div>
          ...
          <div class="firstacc mb-4">    
            <div style="background-color: #EFEFEF;" class="row my-4 mx-1 styleside schoolhover schooldrop">
                <div class="col-sm-6 w3-left my-2">
                    <span id="schooltext" class="spanschool" style="font-size: 1.1em; font-weight: 600;"><?php
                       
                        
                        if(isset($_POST['school_state']))
                        {
                            
                           $head_school= rtrim($_POST['school_state']);
                           echo $head_school;
                            
                        }
                       
                        ?></span><span id="schooltexthide" style="display: none;"><?php if(isset($_POST['school_state']))
                        {
                            
                           $head_school=$_POST['school_state'];
                           echo $head_school;
                            
                        }?></span><span class="pl-3"><i class="fa fa-caret-down"></i></span> 
                </div>
        ...
        <tbody id="maintable11">
            ...
            require_once 'database.php';
                                         ...
                                         if(isset($_POST['school_state'])) {
                                            ...
                                            $landing_code_sbgiop = $_POST['sbgi_value'];
